...
public class RegularShip extends AbstractShip {
	...
	RegularShip(BodyDef bodyDef, FixtureDef fixture, List<Weapon> weapons, boolean isPlayer, int life, 
			EntityContainer container, AnimationTexture textures, CollisionBehavior collisionBehavior) {
		
		super(bodyDef, fixture, weapons, isPlayer, life, container, textures, collisionBehavior);
	}
